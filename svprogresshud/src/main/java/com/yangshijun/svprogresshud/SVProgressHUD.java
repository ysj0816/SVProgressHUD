package com.yangshijun.svprogresshud;
...
import com.yangshijun.svprogresshud.listener.OnDismissListener;
import com.yangshijun.svprogresshud.view.SVCircleProgressBar;
import com.yangshijun.svprogresshud.view.SVProgressDefaultView;
...
public class SVProgressHUD {
    ...
    public void showInfoWithStatus(String string) {
        ...
        svShow();
        scheduleDismiss(DISMISSDELAYED);
    }
    ...
    public void showInfoWithStatus(String string, Long dissmisDelayed) {
        if(isShowing())return;
        setMaskType(SVProgressHUDMaskType.Black);
        mSharedView.showInfoWithStatus(string);
        svShow();
        scheduleDismiss(dissmisDelayed);
    }
    ...
    private void scheduleDismiss(long DISMISSDELAYED) {
        mHandler.removeCallbacksAndMessages(null);
